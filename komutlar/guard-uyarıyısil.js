...
if (!a || !aa) return message.channel.send(`Kişi ve Silinecek Uyarı Miktarı Belirt`)
    ...
    if (aa > sa) {
    message.channel.send(`Bu Üyenin Toplam ${sa} Kadar Uyarısı Var. Sizin Silmeye Çalıştığınız Bundan Daha Büyük Olduğu İçin Maalesef İşlem İptal Oldu! <:red:793011930393739264>`)
  } else {
